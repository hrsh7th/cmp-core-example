---@class complete.kit.App.Command.SubCommand.Argument
---@field public complete? fun(prefix: string):string[]
---@field public required? boolean

---@class complete.kit.App.Command.SubCommandSpecifier
---@field public desc? string
---@field public args? table<string|number, complete.kit.App.Command.SubCommand.Argument>
---@field public execute fun(params: complete.kit.App.Command.ExecuteParams, arguments: table<string, string>)

---@class complete.kit.App.Command.SubCommand: complete.kit.App.Command.SubCommandSpecifier
---@field public name string
---@field public args table<string|number, complete.kit.App.Command.SubCommand.Argument>

---@class complete.kit.App.Command
---@field public name string
---@field public subcommands table<string, complete.kit.App.Command.SubCommand>
local Command = {}
Command.__index = Command

---Create a new command.
---@param name string
---@param subcommand_specifiers table<string, complete.kit.App.Command.SubCommandSpecifier>
...
---@class complete.kit.App.Command.ExecuteParams
---@field public name string
...
---Execute command.
---@param params complete.kit.App.Command.ExecuteParams
