...
---@class complete.kit.App.Config.Schema

---@alias complete.kit.App.Config.SchemaInternal complete.kit.App.Config.Schema|{ revision: integer }

---@class complete.kit.App.Config
---@field private _cache complete.kit.App.Cache
---@field private _default complete.kit.App.Config.SchemaInternal
---@field private _global complete.kit.App.Config.SchemaInternal
---@field private _filetype table<string, complete.kit.App.Config.SchemaInternal>
---@field private _buffer table<integer, complete.kit.App.Config.SchemaInternal>
local Config = {}
Config.__index = Config

---Create new config instance.
---@param default complete.kit.App.Config.Schema
...
---@param config complete.kit.App.Config.Schema
...
---@return complete.kit.App.Config.Schema
function Config:get()
...
---@return fun(config: complete.kit.App.Config.Schema)|{ filetype: fun(filetypes: string|string[], config: complete.kit.App.Config.Schema), buffer: fun(bufnr: integer, config: complete.kit.App.Config.Schema) }
