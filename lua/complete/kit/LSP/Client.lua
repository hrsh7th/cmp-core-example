...
local AsyncTask = require('complete.kit.Async.AsyncTask')

---@class complete.kit.LSP.Client
...
---@param client table
---@return complete.kit.LSP.Client
...
---@param params complete.kit.LSP.ImplementationParams
...
---@param params complete.kit.LSP.TypeDefinitionParams
...
---@class complete.kit.LSP.IntersectionType01 : complete.kit.LSP.ConfigurationParams, complete.kit.LSP.PartialResultParams

---@param params complete.kit.LSP.IntersectionType01
...
---@param params complete.kit.LSP.DocumentColorParams
...
---@param params complete.kit.LSP.ColorPresentationParams
...
---@param params complete.kit.LSP.FoldingRangeParams
...
---@param params complete.kit.LSP.DeclarationParams
...
---@param params complete.kit.LSP.SelectionRangeParams
...
---@param params complete.kit.LSP.WorkDoneProgressCreateParams
...
---@param params complete.kit.LSP.CallHierarchyPrepareParams
...
---@param params complete.kit.LSP.CallHierarchyIncomingCallsParams
...
---@param params complete.kit.LSP.CallHierarchyOutgoingCallsParams
...
---@param params complete.kit.LSP.SemanticTokensParams
...
---@param params complete.kit.LSP.SemanticTokensDeltaParams
...
---@param params complete.kit.LSP.SemanticTokensRangeParams
...
---@param params complete.kit.LSP.ShowDocumentParams
...
---@param params complete.kit.LSP.LinkedEditingRangeParams
...
---@param params complete.kit.LSP.CreateFilesParams
...
---@param params complete.kit.LSP.RenameFilesParams
...
---@param params complete.kit.LSP.DeleteFilesParams
...
---@param params complete.kit.LSP.MonikerParams
...
---@param params complete.kit.LSP.TypeHierarchyPrepareParams
...
---@param params complete.kit.LSP.TypeHierarchySupertypesParams
...
---@param params complete.kit.LSP.TypeHierarchySubtypesParams
...
---@param params complete.kit.LSP.InlineValueParams
...
---@param params complete.kit.LSP.InlayHintParams
...
---@param params complete.kit.LSP.InlayHint
...
---@param params complete.kit.LSP.DocumentDiagnosticParams
...
---@param params complete.kit.LSP.WorkspaceDiagnosticParams
...
---@param params complete.kit.LSP.RegistrationParams
...
---@param params complete.kit.LSP.UnregistrationParams
...
---@param params complete.kit.LSP.InitializeParams
...
---@param params complete.kit.LSP.ShowMessageRequestParams
...
---@param params complete.kit.LSP.WillSaveTextDocumentParams
...
---@param params complete.kit.LSP.CompletionParams
...
---@param params complete.kit.LSP.CompletionItem
...
---@param params complete.kit.LSP.HoverParams
...
---@param params complete.kit.LSP.SignatureHelpParams
...
---@param params complete.kit.LSP.DefinitionParams
...
---@param params complete.kit.LSP.ReferenceParams
...
---@param params complete.kit.LSP.DocumentHighlightParams
...
---@param params complete.kit.LSP.DocumentSymbolParams
...
---@param params complete.kit.LSP.CodeActionParams
...
---@param params complete.kit.LSP.CodeAction
...
---@param params complete.kit.LSP.WorkspaceSymbolParams
...
---@param params complete.kit.LSP.WorkspaceSymbol
...
---@param params complete.kit.LSP.CodeLensParams
...
---@param params complete.kit.LSP.CodeLens
...
---@param params complete.kit.LSP.DocumentLinkParams
...
---@param params complete.kit.LSP.DocumentLink
...
---@param params complete.kit.LSP.DocumentFormattingParams
...
---@param params complete.kit.LSP.DocumentRangeFormattingParams
...
---@param params complete.kit.LSP.DocumentOnTypeFormattingParams
...
---@param params complete.kit.LSP.RenameParams
...
---@param params complete.kit.LSP.PrepareRenameParams
...
---@param params complete.kit.LSP.ExecuteCommandParams
...
---@param params complete.kit.LSP.ApplyWorkspaceEditParams
