...
---@alias complete.kit.Vim.FloatingWindow.WindowKind 'main' | 'scrollbar_track' | 'scrollbar_thumb'

---@class complete.kit.Vim.FloatingWindow.BorderSize
...
---@class complete.kit.Vim.FloatingWindow.ContentSize
---@field public width integer
---@field public height integer

---@class complete.kit.Vim.FloatingWindow.WindowConfig
...
---@class complete.kit.Vim.FloatingWindow.Viewport
...
---@field public border_size complete.kit.Vim.FloatingWindow.BorderSize
---@field public content_size complete.kit.Vim.FloatingWindow.ContentSize
...
---@field private _config complete.kit.Vim.FloatingWindow.Config
...
---@param win? integer
---@param buf integer
---@param win_config complete.kit.Vim.FloatingWindow.WindowConfig
---@return integer
...
---@return complete.kit.Vim.FloatingWindow.BorderSize
...
---@return complete.kit.Vim.FloatingWindow.ContentSize
...
---@param params { border_size: complete.kit.Vim.FloatingWindow.BorderSize, content_size: complete.kit.Vim.FloatingWindow.ContentSize, max_outer_width: integer, max_outer_height: integer }
...
---Get config.
---@return complete.kit.Vim.FloatingWindow.Config
...
---@param key string
---@param value any
---@param kind? complete.kit.Vim.FloatingWindow.WindowKind
...
---@return complete.kit.Vim.FloatingWindow.Viewport
