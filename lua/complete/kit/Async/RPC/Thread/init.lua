...
local Session = require('complete.kit.Async.RPC.Session')

---@class complete.kit.Async.RPC.Thread
---@field private thread uv.luv_thread_t
---@field private session complete.kit.Async.RPC.Session
local Thread = {}
Thread.__index = Thread

---Create new thread.
---@param dispatcher_ fun(session: complete.kit.Async.RPC.Session)
