...
---@class complete.kit.Async.AsyncTask
---@field private value any
---@field private status complete.kit.Async.AsyncTask.Status
...
---@param task complete.kit.Async.AsyncTask
---@param status complete.kit.Async.AsyncTask.Status
---@param value any
...
---@enum complete.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: complete.kit.Async.AsyncTask.Status, value: any }
