...
---@enum cmp-core.kit.LSP.SemanticTokenTypes
...
---@enum cmp-core.kit.LSP.SemanticTokenModifiers
...
---@enum cmp-core.kit.LSP.DocumentDiagnosticReportKind
LSP.DocumentDiagnosticReportKind = {
  Full = 'full',
  Unchanged = 'unchanged',
}

---@enum cmp-core.kit.LSP.ErrorCodes
LSP.ErrorCodes = {
  ParseError = -32700,
...
---@enum cmp-core.kit.LSP.LSPErrorCodes
LSP.LSPErrorCodes = {
  RequestFailed = -32803,
...
---@enum cmp-core.kit.LSP.FoldingRangeKind
...
---@enum cmp-core.kit.LSP.SymbolKind
LSP.SymbolKind = {
  File = 1,
  Module = 2,
  Namespace = 3,
...
---@enum cmp-core.kit.LSP.SymbolTag
LSP.SymbolTag = {
  Deprecated = 1,
}

---@enum cmp-core.kit.LSP.UniquenessLevel
LSP.UniquenessLevel = {
  document = 'document',
  project = 'project',
  group = 'group',
...
---@enum cmp-core.kit.LSP.MonikerKind
LSP.MonikerKind = {
  import = 'import',
  export = 'export',
  ['local'] = 'local',
...
---@enum cmp-core.kit.LSP.InlayHintKind
LSP.InlayHintKind = {
  Type = 1,
  Parameter = 2,
}

---@enum cmp-core.kit.LSP.MessageType
LSP.MessageType = {
  Error = 1,
  Warning = 2,
  Info = 3,
...
---@enum cmp-core.kit.LSP.TextDocumentSyncKind
...
---@enum cmp-core.kit.LSP.TextDocumentSaveReason
...
---@enum cmp-core.kit.LSP.CompletionItemKind
...
---@enum cmp-core.kit.LSP.CompletionItemTag
LSP.CompletionItemTag = {
  Deprecated = 1,
}

---@enum cmp-core.kit.LSP.InsertTextFormat
LSP.InsertTextFormat = {
  PlainText = 1,
  Snippet = 2,
}

---@enum cmp-core.kit.LSP.InsertTextMode
LSP.InsertTextMode = {
  asIs = 1,
  adjustIndentation = 2,
}

---@enum cmp-core.kit.LSP.DocumentHighlightKind
...
---@enum cmp-core.kit.LSP.CodeActionKind
LSP.CodeActionKind = {
  Empty = '',
  QuickFix = 'quickfix',
  Refactor = 'refactor',
...
---@enum cmp-core.kit.LSP.TraceValues
LSP.TraceValues = {
  Off = 'off',
  Messages = 'messages',
  Verbose = 'verbose',
...
---@enum cmp-core.kit.LSP.MarkupKind
LSP.MarkupKind = {
  PlainText = 'plaintext',
  Markdown = 'markdown',
}

---@enum cmp-core.kit.LSP.PositionEncodingKind
...
---@enum cmp-core.kit.LSP.FileChangeType
LSP.FileChangeType = {
  Created = 1,
  Changed = 2,
  Deleted = 3,
...
---@enum cmp-core.kit.LSP.WatchKind
LSP.WatchKind = {
  Create = 1,
  Change = 2,
  Delete = 4,
...
---@enum cmp-core.kit.LSP.DiagnosticSeverity
...
---@enum cmp-core.kit.LSP.DiagnosticTag
LSP.DiagnosticTag = {
  Unnecessary = 1,
  Deprecated = 2,
}

---@enum cmp-core.kit.LSP.CompletionTriggerKind
...
---@enum cmp-core.kit.LSP.SignatureHelpTriggerKind
...
---@enum cmp-core.kit.LSP.CodeActionTriggerKind
LSP.CodeActionTriggerKind = {
  Invoked = 1,
  Automatic = 2,
}

---@enum cmp-core.kit.LSP.FileOperationPatternKind
LSP.FileOperationPatternKind = {
  file = 'file',
  folder = 'folder',
}

---@enum cmp-core.kit.LSP.NotebookCellKind
LSP.NotebookCellKind = {
  Markup = 1,
  Code = 2,
}

---@enum cmp-core.kit.LSP.ResourceOperationKind
...
---@enum cmp-core.kit.LSP.FailureHandlingKind
...
---@enum cmp-core.kit.LSP.PrepareSupportDefaultBehavior
LSP.PrepareSupportDefaultBehavior = {
  Identifier = 1,
}

---@enum cmp-core.kit.LSP.TokenFormat
LSP.TokenFormat = {
  Relative = 'relative',
}
...
---@class cmp-core.kit.LSP.DidChangeWorkspaceFoldersParams
---@field public event cmp-core.kit.LSP.WorkspaceFoldersChangeEvent The actual workspace folder change event.

---@class cmp-core.kit.LSP.ConfigurationParams
---@field public items cmp-core.kit.LSP.ConfigurationItem[]
...
---@class cmp-core.kit.LSP.ColorPresentation
...
---@field public textEdit? cmp-core.kit.LSP.TextEdit An [edit](#TextEdit) which is applied to a document when selecting<br>this presentation for the color.  When `falsy` the [label](#ColorPresentation.label)<br>is used.
---@field public additionalTextEdits? cmp-core.kit.LSP.TextEdit[] An optional array of additional [text edits](#TextEdit) that are applied when<br>selecting this color presentation. Edits must not overlap with the main [edit](#ColorPresentation.textEdit) nor with themselves.

---@class cmp-core.kit.LSP.WorkDoneProgressOptions
...
---@class cmp-core.kit.LSP.SelectionRange
...
---@field public kind cmp-core.kit.LSP.SymbolKind The kind of this item.
---@field public tags? cmp-core.kit.LSP.SymbolTag[] Tags for this item.
...
---@field public range cmp-core.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace but everything else, e.g. comments and code.
...
---@class cmp-core.kit.LSP.SemanticTokensDelta
---@field public resultId? string
---@field public edits cmp-core.kit.LSP.SemanticTokensEdit[] The semantic token edits to transform a previous result into a new result.
...
---@class cmp-core.kit.LSP.ShowDocumentParams
...
---@field public selection? cmp-core.kit.LSP.Range An optional selection range if the document is a text<br>document. Clients might ignore the property if an<br>external program is started or the file is not a text<br>file.
...
---@field public detail? string More detail for this item, e.g. the signature of a function.
---@field public uri string The resource identifier of this item.
---@field public range cmp-core.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace<br>but everything else, e.g. comments and code.
...
---@class cmp-core.kit.LSP.InlayHint
---@field public position cmp-core.kit.LSP.Position The position of this hint.
---@field public label (string | cmp-core.kit.LSP.InlayHintLabelPart[]) The label of this hint. A human readable string or an array of<br>InlayHintLabelPart label parts.<br><br>*Note* that neither the string nor the label part can be empty.
---@field public kind? cmp-core.kit.LSP.InlayHintKind The kind of this hint. Can be omitted in which case the client<br>should fall back to a reasonable default.
---@field public textEdits? cmp-core.kit.LSP.TextEdit[] Optional text edits that are performed when accepting this inlay hint.<br><br>*Note* that edits are expected to change the document so that the inlay<br>hint (or its nearest variant) is now part of the document and the inlay<br>hint itself is now obsolete.
---@field public tooltip? (string | cmp-core.kit.LSP.MarkupContent) The tooltip text when you hover over this item.
...
---@class cmp-core.kit.LSP.DocumentDiagnosticReportPartialResult
---@field public relatedDocuments table<string, (cmp-core.kit.LSP.FullDocumentDiagnosticReport | cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport)>
...
---@class cmp-core.kit.LSP.WorkspaceDiagnosticReport
---@field public items cmp-core.kit.LSP.WorkspaceDocumentDiagnosticReport[]

---@class cmp-core.kit.LSP.WorkspaceDiagnosticReportPartialResult
---@field public items cmp-core.kit.LSP.WorkspaceDocumentDiagnosticReport[]

---@class cmp-core.kit.LSP.DidOpenNotebookDocumentParams
---@field public notebookDocument cmp-core.kit.LSP.NotebookDocument The notebook document that got opened.
---@field public cellTextDocuments cmp-core.kit.LSP.TextDocumentItem[] The text documents that represent the content<br>of a notebook cell.

---@class cmp-core.kit.LSP.DidChangeNotebookDocumentParams
---@field public notebookDocument cmp-core.kit.LSP.VersionedNotebookDocumentIdentifier The notebook document that did change. The version number points<br>to the version after all provided changes have been applied. If<br>only the text document content of a cell changes the notebook version<br>doesn't necessarily have to change.
---@field public change cmp-core.kit.LSP.NotebookDocumentChangeEvent The actual changes to the notebook document.<br><br>The changes describe single state changes to the notebook document.<br>So if there are two changes c1 (at array index 0) and c2 (at array<br>index 1) for a notebook in state S then c1 moves the notebook from<br>S to S' and c2 from S' to S''. So c1 is computed on the state S and<br>c2 is computed on the state S'.<br><br>To mirror the content of a notebook using change events use the following approach:<br>- start with the same initial content<br>- apply the 'notebookDocument/didChange' notifications in the order you receive them.<br>- apply the `NotebookChangeEvent`s in a single notification in the order<br>  you receive them.

---@class cmp-core.kit.LSP.DidSaveNotebookDocumentParams
---@field public notebookDocument cmp-core.kit.LSP.NotebookDocumentIdentifier The notebook document that got saved.

---@class cmp-core.kit.LSP.DidCloseNotebookDocumentParams
---@field public notebookDocument cmp-core.kit.LSP.NotebookDocumentIdentifier The notebook document that got closed.
---@field public cellTextDocuments cmp-core.kit.LSP.TextDocumentIdentifier[] The text documents that represent the content<br>of a notebook cell that got closed.

---@class cmp-core.kit.LSP.RegistrationParams
---@field public registrations cmp-core.kit.LSP.Registration[]
...
---@field public serverInfo? cmp-core.kit.LSP.InitializeResult.serverInfo Information about the server.<br><br>@since 3.15.0

---@class cmp-core.kit.LSP.InitializeResult.serverInfo
...
---@class cmp-core.kit.LSP.InitializeError
...
---@class cmp-core.kit.LSP.InitializedParams

---@class cmp-core.kit.LSP.DidChangeConfigurationParams
---@field public settings cmp-core.kit.LSP.LSPAny The actual changed settings

---@class cmp-core.kit.LSP.DidChangeConfigurationRegistrationOptions
---@field public section? (string | string[])

---@class cmp-core.kit.LSP.ShowMessageParams
---@field public type cmp-core.kit.LSP.MessageType The message type. See {@link MessageType}
---@field public message string The actual message.

---@class cmp-core.kit.LSP.ShowMessageRequestParams
---@field public type cmp-core.kit.LSP.MessageType The message type. See {@link MessageType}
---@field public message string The actual message.
---@field public actions? cmp-core.kit.LSP.MessageActionItem[] The message action items to present.

---@class cmp-core.kit.LSP.MessageActionItem
---@field public title string A short title like 'Retry', 'Open Log' etc.

---@class cmp-core.kit.LSP.LogMessageParams
---@field public type cmp-core.kit.LSP.MessageType The message type. See {@link MessageType}
---@field public message string The actual message.

---@class cmp-core.kit.LSP.DidOpenTextDocumentParams
---@field public textDocument cmp-core.kit.LSP.TextDocumentItem The document that was opened.

---@class cmp-core.kit.LSP.DidChangeTextDocumentParams
---@field public textDocument cmp-core.kit.LSP.VersionedTextDocumentIdentifier The document that did change. The version number points<br>to the version after all provided content changes have<br>been applied.
---@field public contentChanges cmp-core.kit.LSP.TextDocumentContentChangeEvent[] The actual content changes. The content changes describe single state changes<br>to the document. So if there are two content changes c1 (at array index 0) and<br>c2 (at array index 1) for a document in state S then c1 moves the document from<br>S to S' and c2 from S' to S''. So c1 is computed on the state S and c2 is computed<br>on the state S'.<br><br>To mirror the content of a document using change events use the following approach:<br>- start with the same initial content<br>- apply the 'textDocument/didChange' notifications in the order you receive them.<br>- apply the `TextDocumentContentChangeEvent`s in a single notification in the order<br>  you receive them.

---@class cmp-core.kit.LSP.TextDocumentChangeRegistrationOptions : cmp-core.kit.LSP.TextDocumentRegistrationOptions
---@field public syncKind cmp-core.kit.LSP.TextDocumentSyncKind How documents are synced to the server.

---@class cmp-core.kit.LSP.DidCloseTextDocumentParams
---@field public textDocument cmp-core.kit.LSP.TextDocumentIdentifier The document that was closed.

---@class cmp-core.kit.LSP.DidSaveTextDocumentParams
...
---@field public reason cmp-core.kit.LSP.TextDocumentSaveReason The 'TextDocumentSaveReason'.

---@class cmp-core.kit.LSP.TextEdit
---@field public range cmp-core.kit.LSP.Range The range of the text document to be manipulated. To insert<br>text into a document create a range where start === end.
---@field public newText string The string to be inserted. For delete operations use an<br>empty string.

---@class cmp-core.kit.LSP.DidChangeWatchedFilesParams
---@field public changes cmp-core.kit.LSP.FileEvent[] The actual file events.

---@class cmp-core.kit.LSP.DidChangeWatchedFilesRegistrationOptions
---@field public watchers cmp-core.kit.LSP.FileSystemWatcher[] The watchers to register.

---@class cmp-core.kit.LSP.PublishDiagnosticsParams
...
---@field public labelDetails? cmp-core.kit.LSP.CompletionItemLabelDetails Additional details for the label<br><br>@since 3.17.0
---@field public kind? cmp-core.kit.LSP.CompletionItemKind The kind of this completion item. Based of the kind<br>an icon is chosen by the editor.
---@field public tags? cmp-core.kit.LSP.CompletionItemTag[] Tags for this completion item.<br><br>@since 3.15.0
...
---@field public documentation? (string | cmp-core.kit.LSP.MarkupContent) A human-readable string that represents a doc-comment.
...
---@field public insertTextFormat? cmp-core.kit.LSP.InsertTextFormat The format of the insert text. The format applies to both the<br>`insertText` property and the `newText` property of a provided<br>`textEdit`. If omitted defaults to `InsertTextFormat.PlainText`.<br><br>Please note that the insertTextFormat doesn't apply to<br>`additionalTextEdits`.
---@field public insertTextMode? cmp-core.kit.LSP.InsertTextMode How whitespace and indentation is handled during completion<br>item insertion. If not provided the clients default value depends on<br>the `textDocument.completion.insertTextMode` client capability.<br><br>@since 3.16.0
---@field public textEdit? (cmp-core.kit.LSP.TextEdit | cmp-core.kit.LSP.InsertReplaceEdit) An [edit](#TextEdit) which is applied to a document when selecting<br>this completion. When an edit is provided the value of<br>[insertText](#CompletionItem.insertText) is ignored.<br><br>Most editors support two different operations when accepting a completion<br>item. One is to insert a completion text and the other is to replace an<br>existing text with a completion text. Since this can usually not be<br>predetermined by a server it can report both ranges. Clients need to<br>signal support for `InsertReplaceEdits` via the<br>`textDocument.completion.insertReplaceSupport` client capability<br>property.<br><br>*Note 1:* The text edit's range as well as both ranges from an insert<br>replace edit must be a [single line] and they must contain the position<br>at which completion has been requested.<br>*Note 2:* If an `InsertReplaceEdit` is returned the edit's insert range<br>must be a prefix of the edit's replace range, that means it must be<br>contained and starting at the same position.<br><br>@since 3.16.0 additional type `InsertReplaceEdit`
...
---@field public command? cmp-core.kit.LSP.Command An optional [command](#Command) that is executed *after* inserting this completion. *Note* that<br>additional modifications to the current document should be described with the<br>[additionalTextEdits](#CompletionItem.additionalTextEdits)-property.
---@field public data? cmp-core.kit.LSP.LSPAny A data entry field that is preserved on a completion item between a<br>[CompletionRequest](#CompletionRequest) and a [CompletionResolveRequest](#CompletionResolveRequest).

---@class cmp-core.kit.LSP.CompletionList
...
---@field public signatures cmp-core.kit.LSP.SignatureInformation[] One or more signatures.
...
---@field public kind cmp-core.kit.LSP.SymbolKind The kind of this symbol.
---@field public tags? cmp-core.kit.LSP.SymbolTag[] Tags for this document symbol.<br><br>@since 3.16.0
---@field public deprecated? boolean Indicates if this symbol is deprecated.<br><br>@deprecated Use tags instead
---@field public range cmp-core.kit.LSP.Range The range enclosing this symbol not including leading/trailing whitespace but everything else<br>like comments. This information is typically used to determine if the clients cursor is<br>inside the symbol to reveal in the symbol in the UI.
...
---@class cmp-core.kit.LSP.Command
...
---@field public arguments? cmp-core.kit.LSP.LSPAny[] Arguments that the command handler should be<br>invoked with.

---@class cmp-core.kit.LSP.CodeAction
---@field public title string A short, human-readable, title for this code action.
---@field public kind? cmp-core.kit.LSP.CodeActionKind The kind of the code action.<br><br>Used to filter code actions.
---@field public diagnostics? cmp-core.kit.LSP.Diagnostic[] The diagnostics that this code action resolves.
...
---@field public location (cmp-core.kit.LSP.Location | { uri: string }) The location of the symbol. Whether a server is allowed to<br>return a location without a range depends on the client<br>capability `workspace.symbol.resolveSupport`.<br><br>See SymbolInformation#location for more details.
---@field public data? cmp-core.kit.LSP.LSPAny A data entry field that is preserved on a workspace symbol between a<br>workspace symbol request and a workspace symbol resolve request.
...
---@field public range cmp-core.kit.LSP.Range The range in which this code lens is valid. Should only span a single line.
...
---@field public range cmp-core.kit.LSP.Range The range this link applies to.
...
---@field public textDocument cmp-core.kit.LSP.TextDocumentIdentifier The document to format.
---@field public position cmp-core.kit.LSP.Position The position around which the on type formatting should happen.<br>This is not necessarily the exact position where the character denoted<br>by the property `ch` got typed.
...
---@class cmp-core.kit.LSP.ExecuteCommandRegistrationOptions : cmp-core.kit.LSP.ExecuteCommandOptions

---@class cmp-core.kit.LSP.ApplyWorkspaceEditParams
...
---@field public edit cmp-core.kit.LSP.WorkspaceEdit The edits to apply.

---@class cmp-core.kit.LSP.ApplyWorkspaceEditResult
...
---@class cmp-core.kit.LSP.WorkDoneProgressBegin
...
---@class cmp-core.kit.LSP.WorkDoneProgressReport
...
---@class cmp-core.kit.LSP.WorkDoneProgressEnd
...
---@class cmp-core.kit.LSP.SetTraceParams
---@field public value cmp-core.kit.LSP.TraceValues

---@class cmp-core.kit.LSP.LogTraceParams
---@field public message string
---@field public verbose? string

---@class cmp-core.kit.LSP.CancelParams
---@field public id (integer | string) The request id to cancel.

---@class cmp-core.kit.LSP.ProgressParams
---@field public token cmp-core.kit.LSP.ProgressToken The progress token provided by the client or server.
---@field public value cmp-core.kit.LSP.LSPAny The progress data.

---@class cmp-core.kit.LSP.TextDocumentPositionParams
---@field public textDocument cmp-core.kit.LSP.TextDocumentIdentifier The text document.
---@field public position cmp-core.kit.LSP.Position The position inside the text document.

---@class cmp-core.kit.LSP.WorkDoneProgressParams
---@field public workDoneToken? cmp-core.kit.LSP.ProgressToken An optional token that a server can use to report work done progress.

---@class cmp-core.kit.LSP.LocationLink
---@field public originSelectionRange? cmp-core.kit.LSP.Range Span of the origin of this link.<br><br>Used as the underlined span for mouse interaction. Defaults to the word range at<br>the definition position.
---@field public targetUri string The target resource identifier of this link.
---@field public targetRange cmp-core.kit.LSP.Range The full target range of this link. If the target for example is a symbol then target range is the<br>range enclosing this symbol not including leading/trailing whitespace but everything else<br>like comments. This information is typically used to highlight the range in the editor.
---@field public targetSelectionRange cmp-core.kit.LSP.Range The range that should be selected and revealed when this link is being followed, e.g the name of a function.<br>Must be contained by the `targetRange`. See also `DocumentSymbol#range`

---@class cmp-core.kit.LSP.Range
...
---@field public removed cmp-core.kit.LSP.WorkspaceFolder[] The array of the removed workspace folders

---@class cmp-core.kit.LSP.ConfigurationItem
...
---@class cmp-core.kit.LSP.TextDocumentIdentifier
---@field public uri string The text document's uri.

---@class cmp-core.kit.LSP.Color
...
---@class cmp-core.kit.LSP.SemanticTokensEdit
...
---@class cmp-core.kit.LSP.TextDocumentEdit
---@field public textDocument cmp-core.kit.LSP.OptionalVersionedTextDocumentIdentifier The text document to change.
---@field public edits (cmp-core.kit.LSP.TextEdit | cmp-core.kit.LSP.AnnotatedTextEdit)[] The edits to be applied.<br><br>@since 3.16.0 - support for AnnotatedTextEdit. This is guarded using a<br>client capability.

---@class cmp-core.kit.LSP.CreateFile : cmp-core.kit.LSP.ResourceOperation
---@field public kind "create" A create
---@field public uri string The resource to create.
---@field public options? cmp-core.kit.LSP.CreateFileOptions Additional options

---@class cmp-core.kit.LSP.RenameFile : cmp-core.kit.LSP.ResourceOperation
...
---@field public options? cmp-core.kit.LSP.RenameFileOptions Rename options.

---@class cmp-core.kit.LSP.DeleteFile : cmp-core.kit.LSP.ResourceOperation
---@field public kind "delete" A delete
---@field public uri string The file to delete.
---@field public options? cmp-core.kit.LSP.DeleteFileOptions Delete options.

---@class cmp-core.kit.LSP.ChangeAnnotation
...
---@class cmp-core.kit.LSP.FileOperationFilter
---@field public scheme? string A Uri scheme like `file` or `untitled`.
---@field public pattern cmp-core.kit.LSP.FileOperationPattern The actual file operation pattern.

---@class cmp-core.kit.LSP.FileRename
...
---@field public stoppedLocation cmp-core.kit.LSP.Range The document range where execution has stopped.<br>Typically the end position of the range denotes the line where the inline values are shown.

---@class cmp-core.kit.LSP.InlineValueText
---@field public range cmp-core.kit.LSP.Range The document range for which the inline value applies.
---@field public text string The text of the inline value.

---@class cmp-core.kit.LSP.InlineValueVariableLookup
---@field public range cmp-core.kit.LSP.Range The document range for which the inline value applies.<br>The range is used to extract the variable name from the underlying document.
...
---@class cmp-core.kit.LSP.InlineValueEvaluatableExpression
...
---@field public tooltip? (string | cmp-core.kit.LSP.MarkupContent) The tooltip text when you hover over this label part. Depending on<br>the client capability `inlayHint.resolveSupport` clients might resolve<br>this property late using the resolve request.
---@field public location? cmp-core.kit.LSP.Location An optional source code location that represents this<br>label part.<br><br>The editor will use this location for the hover and for code navigation<br>features: This part will become a clickable link that resolves to the<br>definition of the symbol at the given location (not necessarily the<br>location itself), it shows the hover that shows at the given location,<br>and it shows a context menu with further code navigation commands.<br><br>Depending on the client capability `inlayHint.resolveSupport` clients<br>might resolve this property late using the resolve request.
---@field public command? cmp-core.kit.LSP.Command An optional command for this label part.<br><br>Depending on the client capability `inlayHint.resolveSupport` clients<br>might resolve this property late using the resolve request.

---@class cmp-core.kit.LSP.MarkupContent
...
---@field public relatedDocuments? table<string, (cmp-core.kit.LSP.FullDocumentDiagnosticReport | cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport)> Diagnostics of related documents. This information is useful<br>in programming languages where code in a file A can generate<br>diagnostics in a file B which A depends on. An example of<br>such a language is C/C++ where marco definitions in a file<br>a.cpp and result in errors in a header file b.hpp.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.RelatedUnchangedDocumentDiagnosticReport : cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport
---@field public relatedDocuments? table<string, (cmp-core.kit.LSP.FullDocumentDiagnosticReport | cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport)> Diagnostics of related documents. This information is useful<br>in programming languages where code in a file A can generate<br>diagnostics in a file B which A depends on. An example of<br>such a language is C/C++ where marco definitions in a file<br>a.cpp and result in errors in a header file b.hpp.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.FullDocumentDiagnosticReport
...
---@field public items cmp-core.kit.LSP.Diagnostic[] The actual items.

---@class cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport
...
---@class cmp-core.kit.LSP.PreviousResultId
...
---@class cmp-core.kit.LSP.NotebookDocument
...
---@field public metadata? cmp-core.kit.LSP.LSPObject Additional metadata stored with the notebook<br>document.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public cells cmp-core.kit.LSP.NotebookCell[] The cells of a notebook.

---@class cmp-core.kit.LSP.TextDocumentItem
---@field public uri string The text document's uri.
...
---@class cmp-core.kit.LSP.VersionedNotebookDocumentIdentifier
---@field public version integer The version number of this notebook document.
---@field public uri string The notebook document's uri.

---@class cmp-core.kit.LSP.NotebookDocumentChangeEvent
---@field public metadata? cmp-core.kit.LSP.LSPObject The changed meta data if any.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public cells? cmp-core.kit.LSP.NotebookDocumentChangeEvent.cells Changes to cells

---@class cmp-core.kit.LSP.NotebookDocumentChangeEvent.cells
---@field public structure? cmp-core.kit.LSP.NotebookDocumentChangeEvent.cells.structure Changes to the cell structure to add or<br>remove cells.
---@field public data? cmp-core.kit.LSP.NotebookCell[] Changes to notebook cells properties like its<br>kind, execution summary or metadata.
---@field public textContent? { document: cmp-core.kit.LSP.VersionedTextDocumentIdentifier, changes: cmp-core.kit.LSP.TextDocumentContentChangeEvent[] }[] Changes to the text content of notebook cells.

---@class cmp-core.kit.LSP.NotebookDocumentChangeEvent.cells.structure
---@field public array cmp-core.kit.LSP.NotebookCellArrayChange The change to the cell array.
---@field public didOpen? cmp-core.kit.LSP.TextDocumentItem[] Additional opened cell text documents.
---@field public didClose? cmp-core.kit.LSP.TextDocumentIdentifier[] Additional closed cell text documents.

---@class cmp-core.kit.LSP.NotebookDocumentIdentifier
---@field public uri string The notebook document's uri.

---@class cmp-core.kit.LSP.Registration
...
---@field public registerOptions? cmp-core.kit.LSP.LSPAny Options necessary for the registration.

---@class cmp-core.kit.LSP.Unregistration
...
---@field public capabilities cmp-core.kit.LSP.ClientCapabilities The capabilities provided by the client (editor or tool)
---@field public initializationOptions? cmp-core.kit.LSP.LSPAny User provided initialization options.
---@field public trace? ("off" | "messages" | "compact" | "verbose") The initial trace setting. If omitted trace is disabled ('off').

---@class cmp-core.kit.LSP._InitializeParams.clientInfo
...
---@class cmp-core.kit.LSP.WorkspaceFoldersInitializeParams
---@field public workspaceFolders? (cmp-core.kit.LSP.WorkspaceFolder[] | nil) The workspace folders configured in the client when the server starts.<br><br>This property is only available if the client supports workspace folders.<br>It can be `null` if the client supports workspace folders but none are<br>configured.<br><br>@since 3.6.0

---@class cmp-core.kit.LSP.ServerCapabilities
---@field public positionEncoding? cmp-core.kit.LSP.PositionEncodingKind The position encoding the server picked from the encodings offered<br>by the client via the client capability `general.positionEncodings`.<br><br>If the client didn't provide any position encodings the only valid<br>value that a server can return is 'utf-16'.<br><br>If omitted it defaults to 'utf-16'.<br><br>@since 3.17.0
---@field public textDocumentSync? (cmp-core.kit.LSP.TextDocumentSyncOptions | cmp-core.kit.LSP.TextDocumentSyncKind) Defines how text documents are synced. Is either a detailed structure<br>defining each notification or for backwards compatibility the<br>TextDocumentSyncKind number.
---@field public notebookDocumentSync? (cmp-core.kit.LSP.NotebookDocumentSyncOptions | cmp-core.kit.LSP.NotebookDocumentSyncRegistrationOptions) Defines how notebook documents are synced.<br><br>@since 3.17.0
---@field public completionProvider? cmp-core.kit.LSP.CompletionOptions The server provides completion support.
---@field public hoverProvider? (boolean | cmp-core.kit.LSP.HoverOptions) The server provides hover support.
---@field public signatureHelpProvider? cmp-core.kit.LSP.SignatureHelpOptions The server provides signature help support.
---@field public declarationProvider? (boolean | cmp-core.kit.LSP.DeclarationOptions | cmp-core.kit.LSP.DeclarationRegistrationOptions) The server provides Goto Declaration support.
---@field public definitionProvider? (boolean | cmp-core.kit.LSP.DefinitionOptions) The server provides goto definition support.
---@field public typeDefinitionProvider? (boolean | cmp-core.kit.LSP.TypeDefinitionOptions | cmp-core.kit.LSP.TypeDefinitionRegistrationOptions) The server provides Goto Type Definition support.
---@field public implementationProvider? (boolean | cmp-core.kit.LSP.ImplementationOptions | cmp-core.kit.LSP.ImplementationRegistrationOptions) The server provides Goto Implementation support.
---@field public referencesProvider? (boolean | cmp-core.kit.LSP.ReferenceOptions) The server provides find references support.
---@field public documentHighlightProvider? (boolean | cmp-core.kit.LSP.DocumentHighlightOptions) The server provides document highlight support.
---@field public documentSymbolProvider? (boolean | cmp-core.kit.LSP.DocumentSymbolOptions) The server provides document symbol support.
---@field public codeActionProvider? (boolean | cmp-core.kit.LSP.CodeActionOptions) The server provides code actions. CodeActionOptions may only be<br>specified if the client states that it supports<br>`codeActionLiteralSupport` in its initial `initialize` request.
---@field public codeLensProvider? cmp-core.kit.LSP.CodeLensOptions The server provides code lens.
---@field public documentLinkProvider? cmp-core.kit.LSP.DocumentLinkOptions The server provides document link support.
---@field public colorProvider? (boolean | cmp-core.kit.LSP.DocumentColorOptions | cmp-core.kit.LSP.DocumentColorRegistrationOptions) The server provides color provider support.
---@field public workspaceSymbolProvider? (boolean | cmp-core.kit.LSP.WorkspaceSymbolOptions) The server provides workspace symbol support.
---@field public documentFormattingProvider? (boolean | cmp-core.kit.LSP.DocumentFormattingOptions) The server provides document formatting.
---@field public documentRangeFormattingProvider? (boolean | cmp-core.kit.LSP.DocumentRangeFormattingOptions) The server provides document range formatting.
---@field public documentOnTypeFormattingProvider? cmp-core.kit.LSP.DocumentOnTypeFormattingOptions The server provides document formatting on typing.
---@field public renameProvider? (boolean | cmp-core.kit.LSP.RenameOptions) The server provides rename support. RenameOptions may only be<br>specified if the client states that it supports<br>`prepareSupport` in its initial `initialize` request.
---@field public foldingRangeProvider? (boolean | cmp-core.kit.LSP.FoldingRangeOptions | cmp-core.kit.LSP.FoldingRangeRegistrationOptions) The server provides folding provider support.
---@field public selectionRangeProvider? (boolean | cmp-core.kit.LSP.SelectionRangeOptions | cmp-core.kit.LSP.SelectionRangeRegistrationOptions) The server provides selection range support.
---@field public executeCommandProvider? cmp-core.kit.LSP.ExecuteCommandOptions The server provides execute command support.
---@field public callHierarchyProvider? (boolean | cmp-core.kit.LSP.CallHierarchyOptions | cmp-core.kit.LSP.CallHierarchyRegistrationOptions) The server provides call hierarchy support.<br><br>@since 3.16.0
---@field public linkedEditingRangeProvider? (boolean | cmp-core.kit.LSP.LinkedEditingRangeOptions | cmp-core.kit.LSP.LinkedEditingRangeRegistrationOptions) The server provides linked editing range support.<br><br>@since 3.16.0
---@field public semanticTokensProvider? (cmp-core.kit.LSP.SemanticTokensOptions | cmp-core.kit.LSP.SemanticTokensRegistrationOptions) The server provides semantic tokens support.<br><br>@since 3.16.0
---@field public monikerProvider? (boolean | cmp-core.kit.LSP.MonikerOptions | cmp-core.kit.LSP.MonikerRegistrationOptions) The server provides moniker support.<br><br>@since 3.16.0
---@field public typeHierarchyProvider? (boolean | cmp-core.kit.LSP.TypeHierarchyOptions | cmp-core.kit.LSP.TypeHierarchyRegistrationOptions) The server provides type hierarchy support.<br><br>@since 3.17.0
---@field public inlineValueProvider? (boolean | cmp-core.kit.LSP.InlineValueOptions | cmp-core.kit.LSP.InlineValueRegistrationOptions) The server provides inline values.<br><br>@since 3.17.0
---@field public inlayHintProvider? (boolean | cmp-core.kit.LSP.InlayHintOptions | cmp-core.kit.LSP.InlayHintRegistrationOptions) The server provides inlay hints.<br><br>@since 3.17.0
---@field public diagnosticProvider? (cmp-core.kit.LSP.DiagnosticOptions | cmp-core.kit.LSP.DiagnosticRegistrationOptions) The server has support for pull model diagnostics.<br><br>@since 3.17.0
---@field public workspace? cmp-core.kit.LSP.ServerCapabilities.workspace Workspace specific server capabilities.
---@field public experimental? cmp-core.kit.LSP.LSPAny Experimental server capabilities.

---@class cmp-core.kit.LSP.ServerCapabilities.workspace
---@field public workspaceFolders? cmp-core.kit.LSP.WorkspaceFoldersServerCapabilities The server supports workspace folder.<br><br>@since 3.6.0
---@field public fileOperations? cmp-core.kit.LSP.FileOperationOptions The server is interested in notifications/requests for operations on files.<br><br>@since 3.16.0

---@class cmp-core.kit.LSP.VersionedTextDocumentIdentifier : cmp-core.kit.LSP.TextDocumentIdentifier
---@field public version integer The version number of this document.

---@class cmp-core.kit.LSP.SaveOptions
---@field public includeText? boolean The client is supposed to include the content on save.

---@class cmp-core.kit.LSP.FileEvent
---@field public uri string The file's uri.
---@field public type cmp-core.kit.LSP.FileChangeType The change type.

---@class cmp-core.kit.LSP.FileSystemWatcher
---@field public globPattern cmp-core.kit.LSP.GlobPattern The glob pattern to watch. See {@link GlobPattern glob pattern} for more detail.<br><br>@since 3.17.0 support for relative patterns.
---@field public kind? cmp-core.kit.LSP.WatchKind The kind of events of interest. If omitted it defaults<br>to WatchKind.Create | WatchKind.Change | WatchKind.Delete<br>which is 7.

---@class cmp-core.kit.LSP.Diagnostic
---@field public range cmp-core.kit.LSP.Range The range at which the message applies
---@field public severity? cmp-core.kit.LSP.DiagnosticSeverity The diagnostic's severity. Can be omitted. If omitted it is up to the<br>client to interpret diagnostics as error, warning, info or hint.
---@field public code? (integer | string) The diagnostic's code, which usually appear in the user interface.
---@field public codeDescription? cmp-core.kit.LSP.CodeDescription An optional property to describe the error code.<br>Requires the code field (above) to be present/not null.<br><br>@since 3.16.0
...
---@field public tags? cmp-core.kit.LSP.DiagnosticTag[] Additional metadata about the diagnostic.<br><br>@since 3.15.0
---@field public relatedInformation? cmp-core.kit.LSP.DiagnosticRelatedInformation[] An array of related diagnostic information, e.g. when symbol-names within<br>a scope collide all definitions can be marked via this property.
---@field public data? cmp-core.kit.LSP.LSPAny A data entry field that is preserved between a `textDocument/publishDiagnostics`<br>notification and `textDocument/codeAction` request.<br><br>@since 3.16.0

---@class cmp-core.kit.LSP.CompletionContext
---@field public triggerKind cmp-core.kit.LSP.CompletionTriggerKind How the completion was triggered.
...
---@class cmp-core.kit.LSP.CompletionItemLabelDetails
...
---@class cmp-core.kit.LSP.InsertReplaceEdit
...
---@field public completionItem? cmp-core.kit.LSP.CompletionOptions.completionItem The server supports the following `CompletionItem` specific<br>capabilities.<br><br>@since 3.17.0
...
---@field public activeSignatureHelp? cmp-core.kit.LSP.SignatureHelp The currently active `SignatureHelp`.<br><br>The `activeSignatureHelp` has its `SignatureHelp.activeSignature` field updated based on<br>the user navigating through available signatures.

---@class cmp-core.kit.LSP.SignatureInformation
---@field public label string The label of this signature. Will be shown in<br>the UI.
---@field public documentation? (string | cmp-core.kit.LSP.MarkupContent) The human-readable doc-comment of this signature. Will be shown<br>in the UI but can be omitted.
...
---@class cmp-core.kit.LSP.OptionalVersionedTextDocumentIdentifier : cmp-core.kit.LSP.TextDocumentIdentifier
...
---@class cmp-core.kit.LSP.AnnotatedTextEdit : cmp-core.kit.LSP.TextEdit
---@field public annotationId cmp-core.kit.LSP.ChangeAnnotationIdentifier The actual identifier of the change annotation

---@class cmp-core.kit.LSP.ResourceOperation
---@field public kind string The resource operation kind.
---@field public annotationId? cmp-core.kit.LSP.ChangeAnnotationIdentifier An optional annotation identifier describing the operation.<br><br>@since 3.16.0

---@class cmp-core.kit.LSP.CreateFileOptions
...
---@class cmp-core.kit.LSP.RenameFileOptions
...
---@class cmp-core.kit.LSP.DeleteFileOptions
...
---@class cmp-core.kit.LSP.FileOperationPattern
...
---@field public matches? cmp-core.kit.LSP.FileOperationPatternKind Whether to match files or folders with this pattern.<br><br>Matches both if undefined.
---@field public options? cmp-core.kit.LSP.FileOperationPatternOptions Additional options used during matching.

---@class cmp-core.kit.LSP.WorkspaceFullDocumentDiagnosticReport : cmp-core.kit.LSP.FullDocumentDiagnosticReport
---@field public uri string The URI for which diagnostic information is reported.
...
---@class cmp-core.kit.LSP.WorkspaceUnchangedDocumentDiagnosticReport : cmp-core.kit.LSP.UnchangedDocumentDiagnosticReport
---@field public uri string The URI for which diagnostic information is reported.
---@field public version (integer | nil) The version number for which the diagnostics are reported.<br>If the document is not marked as open `null` can be provided.

---@class cmp-core.kit.LSP.LSPObject

---@class cmp-core.kit.LSP.NotebookCell
---@field public kind cmp-core.kit.LSP.NotebookCellKind The cell's kind
---@field public document string The URI of the cell's text document<br>content.
---@field public metadata? cmp-core.kit.LSP.LSPObject Additional metadata stored with the cell.<br><br>Note: should always be an object literal (e.g. LSPObject)
---@field public executionSummary? cmp-core.kit.LSP.ExecutionSummary Additional execution summary information<br>if supported by the client.

---@class cmp-core.kit.LSP.NotebookCellArrayChange
---@field public start integer The start oftest of the cell that changed.
---@field public deleteCount integer The deleted cells
---@field public cells? cmp-core.kit.LSP.NotebookCell[] The new cells, if any

---@class cmp-core.kit.LSP.ClientCapabilities
---@field public workspace? cmp-core.kit.LSP.WorkspaceClientCapabilities Workspace specific client capabilities.
---@field public textDocument? cmp-core.kit.LSP.TextDocumentClientCapabilities Text document specific client capabilities.
---@field public notebookDocument? cmp-core.kit.LSP.NotebookDocumentClientCapabilities Capabilities specific to the notebook document support.<br><br>@since 3.17.0
---@field public window? cmp-core.kit.LSP.WindowClientCapabilities Window specific client capabilities.
---@field public general? cmp-core.kit.LSP.GeneralClientCapabilities General client capabilities.<br><br>@since 3.16.0
---@field public experimental? cmp-core.kit.LSP.LSPAny Experimental client capabilities.

---@class cmp-core.kit.LSP.TextDocumentSyncOptions
...
---@field public change? cmp-core.kit.LSP.TextDocumentSyncKind Change notifications are sent to the server. See TextDocumentSyncKind.None, TextDocumentSyncKind.Full<br>and TextDocumentSyncKind.Incremental. If omitted it defaults to TextDocumentSyncKind.None.
...
---@field public save? (boolean | cmp-core.kit.LSP.SaveOptions) If present save notifications are sent to the server. If omitted the notification should not be<br>sent.

---@class cmp-core.kit.LSP.NotebookDocumentSyncOptions
...
---@class cmp-core.kit.LSP.FileOperationOptions
---@field public didCreate? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didCreateFiles notifications.
---@field public willCreate? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willCreateFiles requests.
---@field public didRename? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didRenameFiles notifications.
---@field public willRename? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willRenameFiles requests.
---@field public didDelete? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving didDeleteFiles file notifications.
---@field public willDelete? cmp-core.kit.LSP.FileOperationRegistrationOptions The server is interested in receiving willDeleteFiles file requests.

---@class cmp-core.kit.LSP.CodeDescription
---@field public href string An URI to open with more information about the diagnostic error.

---@class cmp-core.kit.LSP.DiagnosticRelatedInformation
---@field public location cmp-core.kit.LSP.Location The location of this related diagnostic information.
---@field public message string The message of this related diagnostic information.

---@class cmp-core.kit.LSP.ParameterInformation
...
---@field public documentation? (string | cmp-core.kit.LSP.MarkupContent) The human-readable doc-comment of this parameter. Will be shown<br>in the UI but can be omitted.

---@class cmp-core.kit.LSP.NotebookCellTextDocumentFilter
---@field public notebook (string | cmp-core.kit.LSP.NotebookDocumentFilter) A filter that matches against the notebook<br>containing the notebook cell. If a string<br>value is provided it matches against the<br>notebook type. '*' matches every notebook.
...
---@class cmp-core.kit.LSP.FileOperationPatternOptions
---@field public ignoreCase? boolean The pattern should be matched ignoring casing.

---@class cmp-core.kit.LSP.ExecutionSummary
...
---@class cmp-core.kit.LSP.WorkspaceClientCapabilities
...
---@field public workspaceEdit? cmp-core.kit.LSP.WorkspaceEditClientCapabilities Capabilities specific to `WorkspaceEdit`s.
---@field public didChangeConfiguration? cmp-core.kit.LSP.DidChangeConfigurationClientCapabilities Capabilities specific to the `workspace/didChangeConfiguration` notification.
---@field public didChangeWatchedFiles? cmp-core.kit.LSP.DidChangeWatchedFilesClientCapabilities Capabilities specific to the `workspace/didChangeWatchedFiles` notification.
---@field public symbol? cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities Capabilities specific to the `workspace/symbol` request.
---@field public executeCommand? cmp-core.kit.LSP.ExecuteCommandClientCapabilities Capabilities specific to the `workspace/executeCommand` request.
...
---@field public semanticTokens? cmp-core.kit.LSP.SemanticTokensWorkspaceClientCapabilities Capabilities specific to the semantic token requests scoped to the<br>workspace.<br><br>@since 3.16.0.
---@field public codeLens? cmp-core.kit.LSP.CodeLensWorkspaceClientCapabilities Capabilities specific to the code lens requests scoped to the<br>workspace.<br><br>@since 3.16.0.
---@field public fileOperations? cmp-core.kit.LSP.FileOperationClientCapabilities The client has support for file notifications/requests for user operations on files.<br><br>Since 3.16.0
---@field public inlineValue? cmp-core.kit.LSP.InlineValueWorkspaceClientCapabilities Capabilities specific to the inline values requests scoped to the<br>workspace.<br><br>@since 3.17.0.
---@field public inlayHint? cmp-core.kit.LSP.InlayHintWorkspaceClientCapabilities Capabilities specific to the inlay hint requests scoped to the<br>workspace.<br><br>@since 3.17.0.
---@field public diagnostics? cmp-core.kit.LSP.DiagnosticWorkspaceClientCapabilities Capabilities specific to the diagnostic requests scoped to the<br>workspace.<br><br>@since 3.17.0.

---@class cmp-core.kit.LSP.TextDocumentClientCapabilities
---@field public synchronization? cmp-core.kit.LSP.TextDocumentSyncClientCapabilities Defines which synchronization capabilities the client supports.
---@field public completion? cmp-core.kit.LSP.CompletionClientCapabilities Capabilities specific to the `textDocument/completion` request.
---@field public hover? cmp-core.kit.LSP.HoverClientCapabilities Capabilities specific to the `textDocument/hover` request.
---@field public signatureHelp? cmp-core.kit.LSP.SignatureHelpClientCapabilities Capabilities specific to the `textDocument/signatureHelp` request.
---@field public declaration? cmp-core.kit.LSP.DeclarationClientCapabilities Capabilities specific to the `textDocument/declaration` request.<br><br>@since 3.14.0
---@field public definition? cmp-core.kit.LSP.DefinitionClientCapabilities Capabilities specific to the `textDocument/definition` request.
---@field public typeDefinition? cmp-core.kit.LSP.TypeDefinitionClientCapabilities Capabilities specific to the `textDocument/typeDefinition` request.<br><br>@since 3.6.0
---@field public implementation? cmp-core.kit.LSP.ImplementationClientCapabilities Capabilities specific to the `textDocument/implementation` request.<br><br>@since 3.6.0
---@field public references? cmp-core.kit.LSP.ReferenceClientCapabilities Capabilities specific to the `textDocument/references` request.
---@field public documentHighlight? cmp-core.kit.LSP.DocumentHighlightClientCapabilities Capabilities specific to the `textDocument/documentHighlight` request.
---@field public documentSymbol? cmp-core.kit.LSP.DocumentSymbolClientCapabilities Capabilities specific to the `textDocument/documentSymbol` request.
---@field public codeAction? cmp-core.kit.LSP.CodeActionClientCapabilities Capabilities specific to the `textDocument/codeAction` request.
---@field public codeLens? cmp-core.kit.LSP.CodeLensClientCapabilities Capabilities specific to the `textDocument/codeLens` request.
---@field public documentLink? cmp-core.kit.LSP.DocumentLinkClientCapabilities Capabilities specific to the `textDocument/documentLink` request.
---@field public colorProvider? cmp-core.kit.LSP.DocumentColorClientCapabilities Capabilities specific to the `textDocument/documentColor` and the<br>`textDocument/colorPresentation` request.<br><br>@since 3.6.0
---@field public formatting? cmp-core.kit.LSP.DocumentFormattingClientCapabilities Capabilities specific to the `textDocument/formatting` request.
---@field public rangeFormatting? cmp-core.kit.LSP.DocumentRangeFormattingClientCapabilities Capabilities specific to the `textDocument/rangeFormatting` request.
---@field public onTypeFormatting? cmp-core.kit.LSP.DocumentOnTypeFormattingClientCapabilities Capabilities specific to the `textDocument/onTypeFormatting` request.
---@field public rename? cmp-core.kit.LSP.RenameClientCapabilities Capabilities specific to the `textDocument/rename` request.
---@field public foldingRange? cmp-core.kit.LSP.FoldingRangeClientCapabilities Capabilities specific to the `textDocument/foldingRange` request.<br><br>@since 3.10.0
---@field public selectionRange? cmp-core.kit.LSP.SelectionRangeClientCapabilities Capabilities specific to the `textDocument/selectionRange` request.<br><br>@since 3.15.0
---@field public publishDiagnostics? cmp-core.kit.LSP.PublishDiagnosticsClientCapabilities Capabilities specific to the `textDocument/publishDiagnostics` notification.
---@field public callHierarchy? cmp-core.kit.LSP.CallHierarchyClientCapabilities Capabilities specific to the various call hierarchy requests.<br><br>@since 3.16.0
---@field public semanticTokens? cmp-core.kit.LSP.SemanticTokensClientCapabilities Capabilities specific to the various semantic token request.<br><br>@since 3.16.0
---@field public linkedEditingRange? cmp-core.kit.LSP.LinkedEditingRangeClientCapabilities Capabilities specific to the `textDocument/linkedEditingRange` request.<br><br>@since 3.16.0
---@field public moniker? cmp-core.kit.LSP.MonikerClientCapabilities Client capabilities specific to the `textDocument/moniker` request.<br><br>@since 3.16.0
---@field public typeHierarchy? cmp-core.kit.LSP.TypeHierarchyClientCapabilities Capabilities specific to the various type hierarchy requests.<br><br>@since 3.17.0
---@field public inlineValue? cmp-core.kit.LSP.InlineValueClientCapabilities Capabilities specific to the `textDocument/inlineValue` request.<br><br>@since 3.17.0
---@field public inlayHint? cmp-core.kit.LSP.InlayHintClientCapabilities Capabilities specific to the `textDocument/inlayHint` request.<br><br>@since 3.17.0
---@field public diagnostic? cmp-core.kit.LSP.DiagnosticClientCapabilities Capabilities specific to the diagnostic pull model.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.NotebookDocumentClientCapabilities
---@field public synchronization cmp-core.kit.LSP.NotebookDocumentSyncClientCapabilities Capabilities specific to notebook document synchronization<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.WindowClientCapabilities
...
---@field public showMessage? cmp-core.kit.LSP.ShowMessageRequestClientCapabilities Capabilities specific to the showMessage request.<br><br>@since 3.16.0
---@field public showDocument? cmp-core.kit.LSP.ShowDocumentClientCapabilities Capabilities specific to the showDocument request.<br><br>@since 3.16.0

---@class cmp-core.kit.LSP.GeneralClientCapabilities
---@field public staleRequestSupport? cmp-core.kit.LSP.GeneralClientCapabilities.staleRequestSupport Client capability that signals how the client<br>handles stale requests (e.g. a request<br>for which the client will not process the response<br>anymore since the information is outdated).<br><br>@since 3.17.0
---@field public regularExpressions? cmp-core.kit.LSP.RegularExpressionsClientCapabilities Client capabilities specific to regular expressions.<br><br>@since 3.16.0
---@field public markdown? cmp-core.kit.LSP.MarkdownClientCapabilities Client capabilities specific to the client's markdown parser.<br><br>@since 3.16.0
---@field public positionEncodings? cmp-core.kit.LSP.PositionEncodingKind[] The position encodings supported by the client. Client and server<br>have to agree on the same position encoding to ensure that offsets<br>(e.g. character position in a line) are interpreted the same on both<br>sides.<br><br>To keep the protocol backwards compatible the following applies: if<br>the value 'utf-16' is missing from the array of position encodings<br>servers can assume that the client supports UTF-16. UTF-16 is<br>therefore a mandatory encoding.<br><br>If omitted it defaults to ['utf-16'].<br><br>Implementation considerations: since the conversion from one encoding<br>into another requires the content of the file / line the conversion<br>is best done where the file is read which is usually on the server<br>side.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.GeneralClientCapabilities.staleRequestSupport
...
---@class cmp-core.kit.LSP.RelativePattern
---@field public baseUri (cmp-core.kit.LSP.WorkspaceFolder | string) A workspace folder or a base URI to which this pattern will be matched<br>against relatively.
---@field public pattern cmp-core.kit.LSP.Pattern The actual glob pattern;

---@class cmp-core.kit.LSP.WorkspaceEditClientCapabilities
---@field public documentChanges? boolean The client supports versioned document changes in `WorkspaceEdit`s
---@field public resourceOperations? cmp-core.kit.LSP.ResourceOperationKind[] The resource operations the client supports. Clients should at least<br>support 'create', 'rename' and 'delete' files and folders.<br><br>@since 3.13.0
---@field public failureHandling? cmp-core.kit.LSP.FailureHandlingKind The failure handling strategy of a client if applying the workspace edit<br>fails.<br><br>@since 3.13.0
...
---@field public changeAnnotationSupport? cmp-core.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport Whether the client in general supports change annotations on text edits,<br>create file, rename file and delete file changes.<br><br>@since 3.16.0

---@class cmp-core.kit.LSP.WorkspaceEditClientCapabilities.changeAnnotationSupport
...
---@class cmp-core.kit.LSP.DidChangeConfigurationClientCapabilities
---@field public dynamicRegistration? boolean Did change configuration notification supports dynamic registration.

---@class cmp-core.kit.LSP.DidChangeWatchedFilesClientCapabilities
...
---@class cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities
---@field public dynamicRegistration? boolean Symbol request supports dynamic registration.
---@field public symbolKind? cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind Specific capabilities for the `SymbolKind` in the `workspace/symbol` request.
---@field public tagSupport? cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport The client supports tags on `SymbolInformation`.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.16.0
---@field public resolveSupport? cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport The client support partial workspace symbols. The client will send the<br>request `workspaceSymbol/resolve` to the server to resolve additional<br>properties.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.symbolKind
---@field public valueSet? cmp-core.kit.LSP.SymbolKind[] The symbol kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the symbol kinds from `File` to `Array` as defined in<br>the initial version of the protocol.

---@class cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.tagSupport
---@field public valueSet cmp-core.kit.LSP.SymbolTag[] The tags supported by the client.

---@class cmp-core.kit.LSP.WorkspaceSymbolClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily. Usually<br>`location.range`

---@class cmp-core.kit.LSP.ExecuteCommandClientCapabilities
---@field public dynamicRegistration? boolean Execute command supports dynamic registration.

---@class cmp-core.kit.LSP.SemanticTokensWorkspaceClientCapabilities
...
---@class cmp-core.kit.LSP.CodeLensWorkspaceClientCapabilities
...
---@class cmp-core.kit.LSP.FileOperationClientCapabilities
...
---@class cmp-core.kit.LSP.InlineValueWorkspaceClientCapabilities
...
---@class cmp-core.kit.LSP.InlayHintWorkspaceClientCapabilities
...
---@class cmp-core.kit.LSP.DiagnosticWorkspaceClientCapabilities
...
---@class cmp-core.kit.LSP.TextDocumentSyncClientCapabilities
...
---@class cmp-core.kit.LSP.CompletionClientCapabilities
---@field public dynamicRegistration? boolean Whether completion supports dynamic registration.
---@field public completionItem? cmp-core.kit.LSP.CompletionClientCapabilities.completionItem The client supports the following `CompletionItem` specific<br>capabilities.
---@field public completionItemKind? cmp-core.kit.LSP.CompletionClientCapabilities.completionItemKind
---@field public insertTextMode? cmp-core.kit.LSP.InsertTextMode Defines how the client handles whitespace and indentation<br>when accepting a completion item that uses multi line<br>text in either `insertText` or `textEdit`.<br><br>@since 3.17.0
...
---@field public completionList? cmp-core.kit.LSP.CompletionClientCapabilities.completionList The client supports the following `CompletionList` specific<br>capabilities.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionItem
...
---@field public documentationFormat? cmp-core.kit.LSP.MarkupKind[] Client supports the following content formats for the documentation<br>property. The order describes the preferred format of the client.
...
---@field public resolveSupport? cmp-core.kit.LSP.CompletionClientCapabilities.completionItem.resolveSupport Indicates which properties a client can resolve lazily on a completion<br>item. Before version 3.16.0 only the predefined properties `documentation`<br>and `details` could be resolved lazily.<br><br>@since 3.16.0
---@field public insertTextModeSupport? cmp-core.kit.LSP.CompletionClientCapabilities.completionItem.insertTextModeSupport The client supports the `insertTextMode` property on<br>a completion item to override the whitespace handling mode<br>as defined by the client (see `insertTextMode`).<br><br>@since 3.16.0
...
---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionItem.tagSupport
---@field public valueSet cmp-core.kit.LSP.CompletionItemTag[] The tags supported by the client.

---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionItem.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionItem.insertTextModeSupport
---@field public valueSet cmp-core.kit.LSP.InsertTextMode[]

---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionItemKind
---@field public valueSet? cmp-core.kit.LSP.CompletionItemKind[] The completion item kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the completion items kinds from `Text` to `Reference` as defined in<br>the initial version of the protocol.

---@class cmp-core.kit.LSP.CompletionClientCapabilities.completionList
...
---@class cmp-core.kit.LSP.HoverClientCapabilities
---@field public dynamicRegistration? boolean Whether hover supports dynamic registration.
---@field public contentFormat? cmp-core.kit.LSP.MarkupKind[] Client supports the following content formats for the content<br>property. The order describes the preferred format of the client.

---@class cmp-core.kit.LSP.SignatureHelpClientCapabilities
---@field public dynamicRegistration? boolean Whether signature help supports dynamic registration.
---@field public signatureInformation? cmp-core.kit.LSP.SignatureHelpClientCapabilities.signatureInformation The client supports the following `SignatureInformation`<br>specific properties.
...
---@class cmp-core.kit.LSP.SignatureHelpClientCapabilities.signatureInformation
---@field public documentationFormat? cmp-core.kit.LSP.MarkupKind[] Client supports the following content formats for the documentation<br>property. The order describes the preferred format of the client.
---@field public parameterInformation? cmp-core.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation Client capabilities specific to parameter information.
...
---@class cmp-core.kit.LSP.SignatureHelpClientCapabilities.signatureInformation.parameterInformation
...
---@class cmp-core.kit.LSP.DeclarationClientCapabilities
...
---@class cmp-core.kit.LSP.DefinitionClientCapabilities
...
---@class cmp-core.kit.LSP.TypeDefinitionClientCapabilities
...
---@class cmp-core.kit.LSP.ImplementationClientCapabilities
...
---@class cmp-core.kit.LSP.DocumentSymbolClientCapabilities.symbolKind
---@field public valueSet? cmp-core.kit.LSP.SymbolKind[] The symbol kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.<br><br>If this property is not present the client only supports<br>the symbol kinds from `File` to `Array` as defined in<br>the initial version of the protocol.

---@class cmp-core.kit.LSP.DocumentSymbolClientCapabilities.tagSupport
---@field public valueSet cmp-core.kit.LSP.SymbolTag[] The tags supported by the client.

---@class cmp-core.kit.LSP.CodeActionClientCapabilities
---@field public dynamicRegistration? boolean Whether code action supports dynamic registration.
---@field public codeActionLiteralSupport? cmp-core.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport The client support code action literals of type `CodeAction` as a valid<br>response of the `textDocument/codeAction` request. If the property is not<br>set the request can only return `Command` literals.<br><br>@since 3.8.0
...
---@field public resolveSupport? cmp-core.kit.LSP.CodeActionClientCapabilities.resolveSupport Whether the client supports resolving additional code action<br>properties via a separate `codeAction/resolve` request.<br><br>@since 3.16.0
...
---@class cmp-core.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport
---@field public codeActionKind cmp-core.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind The code action kind is support with the following value<br>set.

---@class cmp-core.kit.LSP.CodeActionClientCapabilities.codeActionLiteralSupport.codeActionKind
---@field public valueSet cmp-core.kit.LSP.CodeActionKind[] The code action kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.

---@class cmp-core.kit.LSP.CodeActionClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class cmp-core.kit.LSP.CodeLensClientCapabilities
---@field public dynamicRegistration? boolean Whether code lens supports dynamic registration.

---@class cmp-core.kit.LSP.DocumentLinkClientCapabilities
...
---@class cmp-core.kit.LSP.DocumentColorClientCapabilities
...
---@field public prepareSupportDefaultBehavior? cmp-core.kit.LSP.PrepareSupportDefaultBehavior Client supports the default behavior result.<br><br>The value indicates the default behavior used by the<br>client.<br><br>@since 3.16.0
...
---@class cmp-core.kit.LSP.FoldingRangeClientCapabilities
...
---@field public foldingRangeKind? cmp-core.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind Specific options for the folding range kind.<br><br>@since 3.17.0
---@field public foldingRange? cmp-core.kit.LSP.FoldingRangeClientCapabilities.foldingRange Specific options for the folding range.<br><br>@since 3.17.0

---@class cmp-core.kit.LSP.FoldingRangeClientCapabilities.foldingRangeKind
---@field public valueSet? cmp-core.kit.LSP.FoldingRangeKind[] The folding range kind values the client supports. When this<br>property exists the client also guarantees that it will<br>handle values outside its set gracefully and falls back<br>to a default value when unknown.

---@class cmp-core.kit.LSP.FoldingRangeClientCapabilities.foldingRange
...
---@class cmp-core.kit.LSP.SelectionRangeClientCapabilities
...
---@class cmp-core.kit.LSP.PublishDiagnosticsClientCapabilities
---@field public relatedInformation? boolean Whether the clients accepts diagnostics with related information.
---@field public tagSupport? cmp-core.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport Client supports the tag property to provide meta data about a diagnostic.<br>Clients supporting tags have to handle unknown tags gracefully.<br><br>@since 3.15.0
...
---@class cmp-core.kit.LSP.PublishDiagnosticsClientCapabilities.tagSupport
---@field public valueSet cmp-core.kit.LSP.DiagnosticTag[] The tags supported by the client.

---@class cmp-core.kit.LSP.CallHierarchyClientCapabilities
...
---@field public formats cmp-core.kit.LSP.TokenFormat[] The token formats the clients supports.
...
---@class cmp-core.kit.LSP.SemanticTokensClientCapabilities.requests
...
---@class cmp-core.kit.LSP.LinkedEditingRangeClientCapabilities
---@field public dynamicRegistration? boolean Whether implementation supports dynamic registration. If this is set to `true`<br>the client supports the new `(TextDocumentRegistrationOptions & StaticRegistrationOptions)`<br>return value for the corresponding server capability as well.

---@class cmp-core.kit.LSP.MonikerClientCapabilities
...
---@class cmp-core.kit.LSP.TypeHierarchyClientCapabilities
---@field public dynamicRegistration? boolean Whether implementation supports dynamic registration. If this is set to `true`<br>the client supports the new `(TextDocumentRegistrationOptions & StaticRegistrationOptions)`<br>return value for the corresponding server capability as well.

---@class cmp-core.kit.LSP.InlineValueClientCapabilities
---@field public dynamicRegistration? boolean Whether implementation supports dynamic registration for inline value providers.

---@class cmp-core.kit.LSP.InlayHintClientCapabilities
---@field public dynamicRegistration? boolean Whether inlay hints support dynamic registration.
---@field public resolveSupport? cmp-core.kit.LSP.InlayHintClientCapabilities.resolveSupport Indicates which properties a client can resolve lazily on an inlay<br>hint.

---@class cmp-core.kit.LSP.InlayHintClientCapabilities.resolveSupport
---@field public properties string[] The properties that a client can resolve lazily.

---@class cmp-core.kit.LSP.DiagnosticClientCapabilities
---@field public dynamicRegistration? boolean Whether implementation supports dynamic registration. If this is set to `true`<br>the client supports the new `(TextDocumentRegistrationOptions & StaticRegistrationOptions)`<br>return value for the corresponding server capability as well.
---@field public relatedDocumentSupport? boolean Whether the clients supports related documents for document diagnostic pulls.

---@class cmp-core.kit.LSP.NotebookDocumentSyncClientCapabilities
...
---@class cmp-core.kit.LSP.ShowMessageRequestClientCapabilities
---@field public messageActionItem? cmp-core.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem Capabilities specific to the `MessageActionItem` type.

---@class cmp-core.kit.LSP.ShowMessageRequestClientCapabilities.messageActionItem
...
---@alias cmp-core.kit.LSP.DefinitionLink cmp-core.kit.LSP.LocationLink

---@alias cmp-core.kit.LSP.LSPArray cmp-core.kit.LSP.LSPAny[]

---@alias cmp-core.kit.LSP.LSPAny (cmp-core.kit.LSP.LSPObject | cmp-core.kit.LSP.LSPArray | string | integer | integer | integer | boolean | nil)

---@alias cmp-core.kit.LSP.Declaration (cmp-core.kit.LSP.Location | cmp-core.kit.LSP.Location[])

---@alias cmp-core.kit.LSP.DeclarationLink cmp-core.kit.LSP.LocationLink

---@alias cmp-core.kit.LSP.InlineValue (cmp-core.kit.LSP.InlineValueText | cmp-core.kit.LSP.InlineValueVariableLookup | cmp-core.kit.LSP.InlineValueEvaluatableExpression)

---@alias cmp-core.kit.LSP.DocumentDiagnosticReport (cmp-core.kit.LSP.RelatedFullDocumentDiagnosticReport | cmp-core.kit.LSP.RelatedUnchangedDocumentDiagnosticReport)

---@alias cmp-core.kit.LSP.PrepareRenameResult (cmp-core.kit.LSP.Range | { range: cmp-core.kit.LSP.Range, placeholder: string } | { defaultBehavior: boolean })

---@alias cmp-core.kit.LSP.ProgressToken (integer | string)

---@alias cmp-core.kit.LSP.DocumentSelector cmp-core.kit.LSP.DocumentFilter[]

---@alias cmp-core.kit.LSP.ChangeAnnotationIdentifier string

---@alias cmp-core.kit.LSP.WorkspaceDocumentDiagnosticReport (cmp-core.kit.LSP.WorkspaceFullDocumentDiagnosticReport | cmp-core.kit.LSP.WorkspaceUnchangedDocumentDiagnosticReport)

---@alias cmp-core.kit.LSP.TextDocumentContentChangeEvent ({ range: cmp-core.kit.LSP.Range, rangeLength?: integer, text: string } | { text: string })

---@alias cmp-core.kit.LSP.MarkedString (string | { language: string, value: string })

---@alias cmp-core.kit.LSP.DocumentFilter (cmp-core.kit.LSP.TextDocumentFilter | cmp-core.kit.LSP.NotebookCellTextDocumentFilter)

---@alias cmp-core.kit.LSP.GlobPattern (cmp-core.kit.LSP.Pattern | cmp-core.kit.LSP.RelativePattern)

---@alias cmp-core.kit.LSP.TextDocumentFilter ({ language: string, scheme?: string, pattern?: string } | { language?: string, scheme: string, pattern?: string } | { language?: string, scheme?: string, pattern: string })

---@alias cmp-core.kit.LSP.NotebookDocumentFilter ({ notebookType: string, scheme?: string, pattern?: string } | { notebookType?: string, scheme: string, pattern?: string } | { notebookType?: string, scheme?: string, pattern: string })

---@alias cmp-core.kit.LSP.Pattern string
