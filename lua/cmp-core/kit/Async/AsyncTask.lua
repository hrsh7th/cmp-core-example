...
---@param task cmp-core.kit.Async.AsyncTask
---@param status cmp-core.kit.Async.AsyncTask.Status
---@param value any
...
---@enum cmp-core.kit.Async.AsyncTask.Status
AsyncTask.Status = {
  Pending = 0,
  Fulfilled = 1,
  Rejected = 2,
...
---@return { status: cmp-core.kit.Async.AsyncTask.Status, value: any }
