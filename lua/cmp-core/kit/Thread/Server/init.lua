...
local Session = require('cmp-core.kit.Thread.Server.Session')
...
---@class cmp-core.kit.Thread.Server
---@field private dispatcher fun(session: cmp-core.kit.Thread.Server.Session): nil
---@field private session? cmp-core.kit.Thread.Server.Session
...
---@param dispatcher fun(session: cmp-core.kit.Thread.Server.Session): nil
---@return cmp-core.kit.Thread.Server
...
function Server:connect()
  return Async.run(function()
    ...
    vim.api.nvim_create_autocmd({ 'VimLeave' }, {
      desc = 'cmp-core.kit.Thread.Server:on_exit',
      once = true,
      callback = function()
        self:kill()
      end
